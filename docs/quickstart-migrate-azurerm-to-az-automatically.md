...
$Plan = New-AzUpgradeModulePlan -FromAzureRmVersion 6.13.1 -FilePath 'C:\Scripts\my-azure-script.ps1'
```

```powershell
# Generate an upgrade plan for all the scripts and module files in the specified folder and save it to a variable.
$Plan = New-AzUpgradeModulePlan -FromAzureRmVersion 6.13.1 -DirectoryPath 'C:\Scripts'
```
...
* Currently, only Az PowerShell module version 10.0.0 is supported as a target.
