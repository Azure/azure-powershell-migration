@{
    ...
    RequiredAssemblies = @(
        '.\Resources\Assembly\Newtonsoft.Json.12.0.3\Newtonsoft.Json.dll','.\Resources\Assembly\Microsoft.ApplicationInsights.2.12.0\Microsoft.ApplicationInsights.dll'
    )
