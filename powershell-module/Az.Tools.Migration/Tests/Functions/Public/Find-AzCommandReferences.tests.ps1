...
InModuleScope -ModuleName Az.Tools.Migration -ScriptBlock {
    Describe 'Find-AzCommandReferences tests' {
        It 'Should ignore non-Azure cmdlets found in files' {
            ...
            # act
            $results = Find-AzCommandReferences -FilePath "testfile.ps1" -AzModuleVersion 4
        ...
        It 'Should correctly detect Az cmdlets found in files found by directory search' {
            ...
            # act
            $results = Find-AzCommandReferences -DirectoryPath "C:\test" -AzModuleVersion 4
