function New-AzUpgradeModulePlan
{
    ...
    .PARAMETER ToAzVersion
        Specifies the Az module version to upgrade to. Currently, only Az version 4.6.1 is supported.
    ...
    .EXAMPLE
        ...
        New-AzUpgradeModulePlan -FromAzureRmVersion 6.13.1 -ToAzVersion 4.6.1 -FilePath 'C:\Scripts\my-azure-script.ps1'

    .EXAMPLE
        The following example generates a new Az module upgrade plan for the script and module files located under C:\Scripts.

        New-AzUpgradeModulePlan -FromAzureRmVersion 6.13.1 -ToAzVersion 4.6.1 -DirectoryPath 'C:\Scripts'
    ...
    .EXAMPLE
        ...
        New-AzUpgradeModulePlan -ToAzVersion 4.6.1 -AzureRmCmdReference $references
    ...
    .EXAMPLE
        ...
        $azSpec = Get-AzUpgradeCmdletSpec -ModuleName "Az" -ModuleVersion "4.6.1"
        $azAliases = Get-AzUpgradeAliasSpec -ModuleVersion "4.6.1"

        # execute a batch of module upgrades
        $plan1 = New-AzUpgradeModulePlan -DirectoryPath 'C:\Scripts1' -FromAzureRmVersion '6.13.1' -ToAzVersion 4.6.1 -AzureRmModuleSpec $armSpec -AzModuleSpec $azSpec -AzAliasMappingSpec $azAliases
        $plan2 = New-AzUpgradeModulePlan -DirectoryPath 'C:\Scripts2' -FromAzureRmVersion '6.13.1' -ToAzVersion 4.6.1 -AzureRmModuleSpec $armSpec -AzModuleSpec $azSpec -AzAliasMappingSpec $azAliases
        $plan3 = New-AzUpgradeModulePlan -DirectoryPath 'C:\Scripts3' -FromAzureRmVersion '6.13.1' -ToAzVersion 4.6.1 -AzureRmModuleSpec $armSpec -AzModuleSpec $azSpec -AzAliasMappingSpec $azAliases
    #>
    [CmdletBinding()]
    Param
    (
