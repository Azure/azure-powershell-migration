function Invoke-ModuleUpgradePlan
{
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        ...
        The upgrade plan is generated by running the New-AzModuleUpgradePlan cmdlet.

    .PARAMETER Plan
        Specify the upgrade plan steps to follow. This is usually passed from pipeline input.

    .EXAMPLE
        PS C:\ Find-AzureRmCommandReferences -DirectoryPath 'C:\source\myModule' -AzureRmModuleVersion 6.13.1 | New-AzModuleUpgradePlan -AzModuleVersion 4.2.0 | Invoke-ModuleUpgradePlan
