...
.EXAMPLE
    PS C:\ .\New-AzCmdletSpec.ps1 -AzVersion "9.3.0" -OutputDirectory "$home\desktop\AzCmdletSpec"
    Generates a new Az module 9.3.0 cmdlet spec in the user's desktop folder.
#>
[CmdletBinding()]
Param
(
