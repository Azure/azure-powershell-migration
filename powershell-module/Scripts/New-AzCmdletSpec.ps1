...
.EXAMPLE
    PS C:\ .\New-AzCmdletSpec.ps1 -AzVersion "4.8.0" -OutputDirectory "$home\desktop\AzCmdletSpec"
    Generates a new Az module 4.8.0 cmdlet spec in the user's desktop folder.
#>
[CmdletBinding()]
Param
(
...
function New-ModuleCommandDefinitionsFile
{
    ...
    .EXAMPLE
        PS C:\> New-ModuleCommandDefinitionsFile -ModuleName "Azure.Storage" -ModuleVersion "4.8.0" -OutputDirectory "C:\users\user\desktop"
