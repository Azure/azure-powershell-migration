...
function multiStepInput(context) {
    return __awaiter(this, void 0, void 0, function* () {
        function collectInputs() {
            return __awaiter(this, void 0, void 0, function* () {
                const state = {};
                yield MultiStepInput.run(input => setSourceVersion(input, state));
                return state;
            });
        }
        const title = 'Set Migration Parameter';
        function setSourceVersion(input, state) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return (input) => setTargetVersion(input, state);
            });
        }
        function setTargetVersion(input, state) {
            return __awaiter(this, void 0, void 0, function* () {
